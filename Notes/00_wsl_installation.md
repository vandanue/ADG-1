...
1. Before installing WSL, open `Windows Features` then enable `Windows Subsystem for Linux` and `Virtual Machine Platform`.
2. Open terminal, you can use `PowerShell` or `CMD`.
